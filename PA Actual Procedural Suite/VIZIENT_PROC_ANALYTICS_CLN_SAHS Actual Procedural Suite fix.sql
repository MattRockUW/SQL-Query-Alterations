BEGIN TRY
drop VIEW [Mart_Load_UWHealth].[VIZIENT_PROC_ANALYTICS_CLN_SAHS]
END TRY
BEGIN CATCH
END CATCH
GO
;
CREATE VIEW [Mart_Load_UWHealth].[VIZIENT_PROC_ANALYTICS_CLN_SAHS] 
AS SELECT 
/*
1-22-2025 MAR: Increased the length of the Actual Procedural Suite VARCHAR to prevent truncation.
*/
DISTINCT
